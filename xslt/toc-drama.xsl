...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
    ...
    <xsl:template match="/">
        <xsl:variable name="doc_title" select="'Dramatische Rezeptionszeugnisse'"/>
                    ...
                    <div class="container">
                        <div class="card">
                            <div class="card-header">
                                <h1>Dramatische Rezeptionszeugnisse</h1>
                            </div>
                            <div class="card-body">
                                <table class="table table-striped display" id="tocTable"
                                    ...
                                    <tbody>
                                        <xsl:for-each
                                            select="document('../data/lists/sappho-rez_drama.xml')//*:listBibl/*:bibl">
                                            <tr>
                                                <td>
